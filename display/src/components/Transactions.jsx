        ...
        <div className="px-5 py-10 md:p-20">
            ...
            <div className="bg-primary w-20 h-1"></div>
            {
                transactions.length === 0 ? (
                    <p className="text-foreground mt-5">No transactions available or network error.</p>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
                        {transactions.map((transaction, id) => (
                            <div key={id} className="flex justify-between p-5 bg-white rounded-lg shadow-md my-2">
                                <div>
